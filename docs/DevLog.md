...
> 最近更新：2026-07-29（**改进1: FastAPI API 文档启用**（feat/api-docs）——`backend/api/middleware.py` auth_gate 豁免路径显式添加 `/docs`、`/openapi.json`、`/redoc`。FastAPI Swagger UI 现可通过 `/docs` 直接访问。测试 577 全绿）
